...
const SIDEBAR_ITEMS = [
  ...
  { id: '05', title: 'Designing NoiseShield', target: 'designing' },
  ...
  return (
    <main ref={containerRef} className="relative w-full min-h-screen bg-[#ffffff]">
      ...
      <div className="case-study-content w-full flex">
        ...
        {/* --- LEFT SIDEBAR (Dark Charcoal Background) --- */}
        <aside className="hidden lg:flex flex-col w-[19%] h-screen sticky top-0 bg-[#171918] pl-6 xl:pl-10 pt-[120px] pb-12 z-20 border-r border-white/10 shadow-[8px_0_30px_rgba(0,0,0,0.12)]">
          <button 
            onClick={handleGoBack}
            className="sidebar-anim flex items-center justify-center gap-2 w-fit px-5 py-2 rounded-full border border-white/30 text-white font-dm-sans text-[14px] tracking-[-0.05em] hover:bg-white hover:text-[#171918] transition-colors duration-300 mb-14 opacity-0"
            data-cursor="hover"
          >
              ...
              return (
                <button
                  ...
                  className={`sidebar-anim flex items-center gap-4 text-left transition-all duration-300 opacity-0 ${
                    isActive ? 'text-[#C7E86B] font-medium' : 'text-white/40 hover:text-white/80'
                  }`}
                  data-cursor="hover"
                >
