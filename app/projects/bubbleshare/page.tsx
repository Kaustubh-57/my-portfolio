...
export default function BubbleSharePage() {
  ...
  const handleGoBack = () => {
    ...
    gsap.to('.case-study-content', {
      ...
      ease: 'power2.inOut',
      onComplete: () => {
        // Updated to route back to card 03
        router.push('/?returnTo=03');
      }
    });
  };
  ...
  return (
    <main ref={pageRef} className="w-full min-h-screen bg-[#ffffff] text-[#141613] pt-28 md:pt-36 pb-24 overflow-hidden">
      ...
      <div className="case-study-content w-full max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div 
          ref={blueCardRef}
          className="relative w-full bg-[#4438B5] rounded-t-[24px] md:rounded-t-[32px] pt-12 md:pt-20 px-6 md:px-12 lg:px-16 flex flex-col opacity-0 overflow-hidden"
        >
          ...
          >
            <img 
              src="/projects/bubbleshare/mockup.png" 
